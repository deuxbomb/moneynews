...
## 2026-05-11 09:30 [AM] (테마: AI 인프라/반도체)
- 헤드라인: 반도체가 다시 왕이 됐다 — 삼성·하이닉스 장전 전부터 6% 치솟고, 월가의 AI 러브레터 주소가 바뀌었다
- 오늘의 픽: $MU (카탈리스트: D+9 2026-05-20 투자자 행사, HBM 공급 로드맵 발표), $AVGO (카탈리스트: D+3 2026-05-14~15 트럼프-시진핑 정상회담, 반도체 수출 규제 의제), $INTC (카탈리스트: 애플-인텔 파운드리 계약 상세 발표 임박, AI 추론 데이터센터 성장) [와치리스트 외 발굴]
- 뉴스 토픽: [AI 인프라/반도체] MU $8,000억 돌파/HBM 슈퍼사이클·애플-인텔 파운드리 계약 확정·SMCI Q3 가이던스 서프라이즈 / [기업] TSLA Q1 마진 회복 21.1%/로보택시 26대 운행·NVDA D-9 어닝 카운트다운(5/20)·COIN Q1 어닝미스 -$394M 회복 중 / [매크로] CPI(5/12)·PPI(5/13)·미중 정상회담(5/14~15 베이징)·삼성·하이닉스 프리마켓 6%+ / [코스피] 7,498 4연속 사상최고치
- 팟캐스트: All-In Podcast #272 "스페이스X-앤트로픽 딜, Elon Web Services, 스페이스X IPO 밸류에이션" (2026-05-08)
