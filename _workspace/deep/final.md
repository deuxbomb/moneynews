...
그리고 그 사이에는 조용히 세 번째 선수가 들어왔습니다. Amazon의 자금력 + Uber의 2억 이용자. 죽스(Zoox)의 방정식입니다. 기술 경쟁 대신 플랫폼을 빌려 타는 전략으로 로보택시 전쟁에 뛰어들었습니다. 로보택시 전쟁이 드디어 결전의 해를 맞이하고 있습니다.
...
주당 유료 탑승 50만 건. 1년 전인 2025년 4월의 25만 건에서 정확히 2배가 된 수치입니다. 서울 시내버스가 하루에 약 400~500만 명을 나르는데, 웨이모는 일주일에 미국 전역에서 50만 건의 유료 탑승을 소화하고 있는 거예요. 아직은 대중교통 규모에 한참 못 미치지만, 연말 목표는 주당 100만 건입니다.

이 성장을 뒷받침하는 건 $160억의 탄환입니다. Alphabet이 이 라운드에서만 $130억을 쏟아부었고, 외부 투자자들도 $30억을 더했습니다. "웨이모는 스스로 운전하는 차를 만들었을 뿐 아니라, 인간이나 경쟁 시스템보다 의미 있게 더 잘 운전한다. 우리는 이 리드가 지속될 것이라 믿는다"는 리드 투자자 드라고니어의 발언이 투자자들의 심리를 잘 보여줍니다.

확장 계획도 공격적입니다. 현재 미국 10개 이상 도시에서 런던, 도쿄까지. 런던은 해외 진출 첫 시장이 되고, 도쿄는 우측통행(우핸들) 시장 첫 도전입니다. 2026년 중 추가로 20개 도시에 문을 여는 게 목표예요.

한 가지 아킬레스건이 있다면 **비용**입니다. 웨이모의 현재 마일당 운영 비용은 모건스탠리 추정치 기준 $1.43. 6세대 하드웨어는 5세대 대비 센서 수를 42% 줄이고 단위 원가를 50% 이상 낮췄지만(카메라 13개+라이다 4개+레이더 6개), 웨이모만의 복합 센서 구조가 가져오는 기본 원가는 테슬라와 결이 다릅니다.
...
테슬라의 또 다른 무기는 **데이터 규모**입니다. 5월 4일, Tesla가 FSD 누적 주행 거리 100억 마일(10 billion miles) 돌파를 공식 발표했습니다. 웨이모의 완전 비지도 주행 누적인 2억 마일의 50배에 달해요. 더 의미심장한 건 Musk가 직접 "10억 마일이 완전 비지도 자율주행의 준비 임계점"이라고 발언한 바 있다는 점입니다. 숫자는 맞췄습니다. 이제 문제는 그 다음 단계가 얼마나 빨리 현실이 되느냐입니다.
...
더 흥미로운 건 **Uber와의 파트너십**입니다. 죽스는 이미 2025년 9월 라스베이거스 스트립 일대에서 직접 서비스를 공개 런칭한 상태입니다. 여기서 한 발 더 나아가, 단독 앱에만 머물지 않고 Uber 앱을 통해서도 죽스 로보택시를 호출할 수 있도록 파트너십을 체결했습니다. 이미 수천만 명의 월간 활성 사용자를 가진 Uber의 플랫폼을 빌려 쓰는 거예요. 마케팅 비용과 고객 확보 비용(CAC)을 제로에 가깝게 만드는 전략입니다. 2026년 내 Uber 앱 통한 라스베이거스 유료 서비스, 2027년 LA 확장이 목표고, 오스틴·마이애미 진출도 2026년 내로 예정되어 있습니다.

Amazon의 자금력과 Uber의 네트워크가 뒤를 받쳐주는 이 조합은, 결코 무시할 수 없습니다.
...
로보택시 글로벌 시장 전체는, 기관마다 추정치가 크게 다르지만 복수의 리서치 기관이 2026년 $50~60억 수준에서 2032년 $1,500억~$2,800억 규모로 성장할 것으로 전망합니다. 파이가 폭발적으로 커지는 건 공통된 의견입니다. 문제는 그 파이를 누가 얼마나 가져가느냐.
...
**$TSLA**: 모건스탠리 Equal Weight(중립) 등급, 목표주가 $415. 단기로는 FSD V15 출시와 대규모 확장이 실제로 이뤄지는지가 핵심 촉매입니다. Musk는 "연말까지 수십 개 주"를 약속했는데, 만약 하반기에 실제 확장 속도가 나온다면 주가 재평가의 강력한 이유가 됩니다. 반대로 또 한 번 딜레이가 나오면 신뢰도 문제가 더 깊어질 수 있어요.
...
**② $TSLA는 FSD V15 이후를 보는 게임**입니다. FSD가 드디어 Musk 본인의 '10B 마일 임계점'을 달성했습니다. 2026년 4분기 V15 출시와 실제 도시 확장 속도가 나오는지를 모니터링하세요. 실현되면 강력한 매수 촉매, 또 딜레이되면 그 반대입니다. 지금 당장은 "증명 중"이지 "증명된" 상태가 아닙니다.

**③ 죽스·Uber 조합은 간접 수혜를 노릴 수 있는 포인트**입니다. Zoox가 성공하면 Uber의 네트워크 가치가 재평가될 수 있어요. Uber 자체도 로보택시 전환의 수혜주로 볼 수 있습니다.

---

지금 이 순간, 텍사스 도로 어딘가에서 운전석이 비어있는 테슬라가 달리고 있고, 샌프란시스코에선 사람들이 웨이모를 일상 교통수단으로 쓰고 있습니다. "10년 뒤의 기술"은 이미 와 있습니다. 구경꾼으로 남을지, 플레이어로 참여할지 — 그 선택의 시간이 지금입니다.
...
13. [Automotive World](https://www.automotiveworld.com/news/waymos-6th-gen-driver-goes-live-with-42-fewer-sensors/) — Waymo 6세대 드라이버 42% 적은 센서 (2026)
14. [Electrek](https://electrek.co/2026/05/03/tesla-fsd-10-billion-miles-no-magical-milestone-autonomy/) — Tesla FSD 100억 마일 돌파 (2026.05.03)
15. [HeyGoTrade](https://www.heygotrade.com/en/blog/tesla-q1-2026-earnings-recap/) — Elon Musk Q1 2026 어닝콜 발언
